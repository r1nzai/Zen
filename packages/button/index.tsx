...
const Button = (props: ButtonProps) => {
    let { children, className, variant = 'primary', size = 'medium', rounded = 'md', ...rest } = props;
    return (
        <Component tag="button" className={ButtonStyles({ variant, size, rounded, className })} {...rest}>
            {children}
        </Component>
    );
};
